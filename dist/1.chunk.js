...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__resources_ContainerResource__ = __webpack_require__(421);
...
var ContainerComponent = (function () {
    function ContainerComponent(hostResource, containerResource) {
    ...
    ContainerComponent.prototype.addConnection = function () {
        var _this = this;
        if (this.addConnectionData.type == 'dependency') {
            this.containerResource.addDependency({ container_id: this.addConnectionData.from, dependency_id: this.addConnectionData.to }, function () {
                _this.drawGraph();
            });
        }
        if (this.addConnectionData.type == 'redundancy') {
            this.containerResource.addRedundancy({ container_id: this.addConnectionData.from, redundancy_id: this.addConnectionData.to }, function () {
                _this.drawGraph();
            });
        }
        this.addConnectionData.show = false;
    };
    ContainerComponent.prototype.removeDependency = function (container, dependency) {
        var _this = this;
        this.containerResource.removeDependency({ container_id: container.id, dependency_id: dependency.id }, function () {
            _this.drawGraph();
        });
    };
    ContainerComponent.prototype.removeRedundancy = function (container, redundancy) {
        var _this = this;
        this.containerResource.removeRedundancy({ container_id: container.id, redundancy_id: redundancy.id }, function () {
            _this.drawGraph();
        });
    };
    ContainerComponent.prototype.drawGraph = function () {
        var _this = this;
        this.hostResource.query(null, function (response) {
            _this.hosts = response;
            var nodes = [];
            var edges = [];
            for (var _i = 0, response_1 = response; _i < response_1.length; _i++) {
                var host = response_1[_i];
                if (host.containers.length > 0) {
                    nodes.push({ data: { id: 'h_' + host.id, name: host.name, address: host.address } });
                    for (var _a = 0, _b = host.containers; _a < _b.length; _a++) {
                        var container = _b[_a];
                        nodes.push({ data: { id: 'c_' + container.id, parent: 'h_' + host.id, name: container.name } });
                        for (var _c = 0, _d = container.dependencies; _c < _d.length; _c++) {
                        ...
                        for (var _e = 0, _f = container.redundancies; _e < _f.length; _e++) {
                            var redundancy = _f[_e];
                            edges.push({
                                data: {
                        ...
                        for (var _g = 0, _h = container.redundant_nodes; _g < _h.length; _g++) {
                            var redundancy = _h[_g];
                            edges.push({
                                data: {
                                    id: 'r_' + container.id + '_' + redundancy.id,
                                    source: 'c_' + container.id,
            ...
            _this.cyoptions['container'] = document.getElementById('graph_container');
            _this.cyoptions['elements'] = { nodes: nodes, edges: edges };
            _this.cy = cytoscape(_this.cyoptions);
        });
    };
    ContainerComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.drawGraph();
        this.containerResource.query(null, function (containers) {
...
ContainerComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__resources_HostResource__["a" /* HostResource */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__resources_HostResource__["a" /* HostResource */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__resources_ContainerResource__["a" /* ContainerResource */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__resources_ContainerResource__["a" /* ContainerResource */]) === "function" && _b || Object])
], ContainerComponent);

var _a, _b;
//# sourceMappingURL=/home/florian/PhpstormProjects/drvt-frontend/src/container.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__container_component__ = __webpack_require__(1020);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContainerRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__container_component__["a" /* ContainerComponent */],
        data: {
            title: 'Container'
        }
    }
];
var ContainerRoutingModule = (function () {
...
//# sourceMappingURL=/home/florian/PhpstormProjects/drvt-frontend/src/container-routing.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__container_component__ = __webpack_require__(1020);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__container_routing_module__ = __webpack_require__(1023);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_common__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(1013);
...
ContainerModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__container_routing_module__["a" /* ContainerRoutingModule */],
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_2__container_component__["a" /* ContainerComponent */]]
    })
], ContainerModule);

//# sourceMappingURL=/home/florian/PhpstormProjects/drvt-frontend/src/container.module.js.map
